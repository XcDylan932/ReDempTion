...
CoD.ZmAmmo_EquipTac.new = function ( menu, controller )
	...
	CoD.UIColors.SetElementColor( self.Tactical0, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
	...
	CoD.UIColors.SetElementColor( self.Tactical1, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
	...
	CoD.UIColors.SetElementColor( self.Tactical2, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
	...
	CoD.UIColors.SetElementColor( self.Tactical3, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
