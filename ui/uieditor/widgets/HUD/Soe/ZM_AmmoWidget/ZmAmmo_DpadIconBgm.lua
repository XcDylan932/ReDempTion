local PostLoadFunc = function( self, controller, menu )
    ...
    self.UpdateColors = function( self )
		...
		self.GlowOrangeOver:beginAnimation( "keyframe", 1000, false, false, CoD.TweenType.Linear )
...
CoD.ZmAmmo_DpadIconBgm.new = function ( menu, controller )
	...
	self.IconImgBgmBaseInvalid:setImage( RegisterImage( "uie_t7_zm_hud_ammo_noshield" ) )
	...
	self.IconImgBgmBaseNew:setImage( RegisterImage( "uie_t7_zm_hud_ammo_newshield" ) )
	self:addElement( self.IconImgBgmBaseNew )
	
	self.IconImgBgmDisabled = LUI.UIImage.new()
	self.IconImgBgmDisabled:setLeftRight( false, false, -23, 20 )
	self.IconImgBgmDisabled:setTopBottom( false, false, -17.5, 25.5 )
	self.IconImgBgmDisabled:setAlpha( 0 )
	self.IconImgBgmDisabled:setImage( RegisterImage( "uie_t7_zm_hud_ammo_dpadicnbblgm_new_inactive" ) )
	self:addElement( self.IconImgBgmDisabled )
	
	self.IconImgBgmActive = LUI.UIImage.new()
	self.IconImgBgmActive:setLeftRight( false, false, -23, 20 )
	self.IconImgBgmActive:setTopBottom( false, false, -17.5, 25.5 )
	self.IconImgBgmActive:setAlpha( 0 )
	self.IconImgBgmActive:setImage( RegisterImage( "uie_t7_zm_hud_ammo_dpadicnbblgm_new" ) )
	self:addElement( self.IconImgBgmActive )
	
	self.GlowOrangeOver = LUI.UIImage.new()
	self.GlowOrangeOver:setLeftRight( false, false, -14.25, 10.25 )
	self.GlowOrangeOver:setTopBottom( false, false, -18, 26 )
	CoD.UIColors.SetElementColor( self.GlowOrangeOver, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
					...
					local GlowOrangeOverFrame3 = function ( element, event )
						local GlowOrangeOverFrame4 = function ( element, event )
							local GlowOrangeOverFrame5 = function ( element, event )
								if not event.interrupted then
									element:beginAnimation( "keyframe", 860, false, false, CoD.TweenType.Linear )
								end
								element:setLeftRight( true, false, 0.57, 16.43 )
								element:setTopBottom( true, false, -10, 26 )
								element:setAlpha( 0 )
								if event.interrupted then
									self.clipFinished( element, event )
								else
