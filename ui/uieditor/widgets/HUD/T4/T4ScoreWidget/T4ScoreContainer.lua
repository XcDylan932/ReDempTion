require( "ui.uieditor.widgets.HUD.T4.T4ScoreWidget.T4ClientScore" )
require( "ui.uieditor.widgets.HUD.T4.T4ScoreWidget.T4PlusPointsContainer" )
require( "ui.uieditor.widgets.HUD.T4.T4ScoreWidget.T4SelfScore" )
