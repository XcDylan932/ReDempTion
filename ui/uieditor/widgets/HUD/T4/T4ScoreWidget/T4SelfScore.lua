local PostLoadFunc = function ( self, controller )
	...
	self.UpdateColors = function( self )
        ...
        self.Score:beginAnimation( "keyframe", 1000, false, false, CoD.TweenType.Linear )
        CoD.UIColors.SetElementColor( self.Score, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
    end
