...
CoD.T4AmmoEquipment.new = function ( menu, controller )
	...
	local specialOffsetLR = -50

	self.Special = LUI.UIImage.new()
	self.Special:setLeftRight( false, true, -240 + specialOffsetLR, -200 + specialOffsetLR )
	self.Special:setTopBottom( false, true, -60 - 2, -20 - 2 )
	self.Special:setImage( RegisterImage( "blacktransparent" ) )
	self.Special:setScale( 0.765 )
	...
	self.SpecialMeterBG:setLeftRight( false, true, -250 + specialOffsetLR, -190 + specialOffsetLR )
	self.SpecialMeterBG:setTopBottom( false, true, -25, -18 )
	...
	self.SpecialMeterBG:setScale( 0.51 )
	...
	self.SpecialMeter:setLeftRight( false, true, -248 + specialOffsetLR, -192 + specialOffsetLR )
	self.SpecialMeter:setTopBottom( false, true, -23, -20 )
	self.SpecialMeter:setImage( RegisterImage( "blacktransparent" ) )
	self.SpecialMeter:setScale( 0.51 )
