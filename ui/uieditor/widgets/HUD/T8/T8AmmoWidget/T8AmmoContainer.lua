require( "ui.uieditor.widgets.HUD.T8.T8AmmoWidget.T8AmmoEquipment" )
require( "ui.uieditor.widgets.HUD.T8.T8AmmoWidget.T8AmmoInfo" )
require( "ui.uieditor.widgets.HUD.T8.T8AmmoWidget.T8AmmoWeaponImages" )
require( "ui.uieditor.widgets.HUD.ZM_AmmoWidget.ZmAmmo_BBGumMeterWidget" )

local PostLoadFunc = function( self, controller, menu )
    self.UpdateColors = function( self )
        local elements = { self.AmmoBG, self.BGBBG, self.AmmoEquipment.LethalBG, self.AmmoEquipment.TacticalBG, self.AmmoEquipment.SpecialBG }
