...
CoD.LuaPrint.new = function( menu, controller )
    ...
    self.CreateNotificationElement = function( self, message )
        ...
        CoD.UIColors.SetElementColor( glow, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
        glow:setAlpha( 0.66 )
        ...
        CoD.UIColors.SetElementColor( text, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
