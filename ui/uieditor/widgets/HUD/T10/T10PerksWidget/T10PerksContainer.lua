require( "ui.uieditor.widgets.HUD.T10.T10PerksWidget.T10PerksListItem" )
require( "ui.uieditor.widgets.HUD.ZM_Perks.ZMPerksTable" )

local activePerksTable = CoD.ZMPerksTable[6]
...
DataSources.T10Perks = DataSourceHelpers.ListSetup( "T10Perks", function( controller, element )
...
CoD.T10PerksContainer.new = function( menu, controller )
	...
	self.PerkList:setDataSource( "T10Perks" )
