...
CoD.ZmAmmo_DpadIconLeftFactory.new = function ( menu, controller )
	...
	self.IconImgMineBaseInvalid:setLeftRight( false, false, -33, 46 )
	self.IconImgMineBaseInvalid:setTopBottom( false, false, -60.27, 60.27 )
	self.IconImgMineBaseInvalid:setAlpha( 0 )
	self.IconImgMineBaseInvalid:setImage( RegisterImage( "uie_t7_zm_derriese_hd_hud_ammo_cover_unavailable" ) )
	self:addElement( self.IconImgMineBaseInvalid )
	
	self.IconImgMineBaseNew = LUI.UIImage.new()
	self.IconImgMineBaseNew:setLeftRight( false, false, -33, 46 )
	self.IconImgMineBaseNew:setTopBottom( false, false, -60.27, 60.27 )
	self.IconImgMineBaseNew:setAlpha( 0 )
	self.IconImgMineBaseNew:setImage( RegisterImage( "uie_t7_zm_derriese_hd_hud_ammo_cover_flash" ) )
	self:addElement( self.IconImgMineBaseNew )
	
	self.IconImgMineDisabled = LUI.UIImage.new()
	self.IconImgMineDisabled:setLeftRight( false, false, -15, 23 )
	self.IconImgMineDisabled:setTopBottom( false, false, -20, 18.97 )
	self.IconImgMineDisabled:setAlpha( 0 )
	self.IconImgMineDisabled:setScale( 0.9 )
	self.IconImgMineDisabled:setImage( RegisterImage( "uie_t7_zm_derriese_hud_ammo_icon_mine_inactive" ) )
	self:addElement( self.IconImgMineDisabled )
	
	self.IconImgMineActive = LUI.UIImage.new()
	self.IconImgMineActive:setLeftRight( false, false, -15, 23 )
	self.IconImgMineActive:setTopBottom( false, false, -20, 18.97 )
	self.IconImgMineActive:setAlpha( 0 )
	self.IconImgMineActive:setScale( 0.9 )
	self.IconImgMineActive:setImage( RegisterImage( "uie_t7_zm_derriese_hud_ammo_icon_mine" ) )
