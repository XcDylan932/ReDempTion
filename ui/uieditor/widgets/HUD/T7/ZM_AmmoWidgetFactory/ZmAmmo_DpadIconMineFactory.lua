...
CoD.ZmAmmo_DpadIconMineFactory.new = function ( menu, controller )
	...
	self.IconImgMineBaseInvalid:setImage( RegisterImage( "uie_t7_zm_derriese_hud_ammo_dpadmtr_right_unavailable" ) )
	...
	self.IconImgMineBaseNew:setImage( RegisterImage( "uie_t7_zm_derriese_hud_ammo_dpadmtr_right_flash" ) )
	...
	self.IconImgMineActive:setLeftRight( false, false, -16.03, 24 )
	self.IconImgMineActive:setTopBottom( false, false, -23, 15.97 )
