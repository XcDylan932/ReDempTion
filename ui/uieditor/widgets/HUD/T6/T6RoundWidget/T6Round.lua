local PostLoadFunc = function( self, controller, menu )
    self.UpdateColors = function( self )
        local elements = { self.Chalks1, self.Chalks2, self.RoundText, self.RoundMiddleText }
...
CoD.T6Round.new = function ( menu, controller )
	...
	CoD.UIColors.SetElementColor( self.Chalks1, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
	...
	CoD.UIColors.SetElementColor( self.Chalks2, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
	...
	CoD.UIColors.SetElementColor( self.RoundText, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
	...
	CoD.UIColors.SetElementColor( self.RoundMiddleText, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
