...
local activePerksTable = CoD.ZMPerksTable[4]
...
DataSources.T6Perks = DataSourceHelpers.ListSetup( "T6Perks", function ( controller, element )
...
CoD.T6PerksContainer.new = function ( menu, controller )
	...
	self.PerkList:setDataSource( "T6Perks" )
