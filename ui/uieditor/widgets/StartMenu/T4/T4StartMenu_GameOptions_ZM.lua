...
require( "ui.uieditor.widgets.StartMenu.T4.T4StartMenu_Options" )
require( "ui.uieditor.widgets.Lobby.Common.T4ButtonListItem" )

DataSources.T4StartMenuGameOptions = ListHelper_SetupDataSource( "T4StartMenuGameOptions", function ( controller )
	local options = {}

	if CoD.isZombie then
		table.insert( options, {
			models = { displayText = "MENU_ZOMBIE_RESUMEGAME_CAPS", action = StartMenuGoBack_ListElement }
		} )
...
CoD.T4StartMenu_GameOptions_ZM.new = function ( menu, controller )
	...
	self.buttonList:setDataSource( "T4StartMenuGameOptions" )
