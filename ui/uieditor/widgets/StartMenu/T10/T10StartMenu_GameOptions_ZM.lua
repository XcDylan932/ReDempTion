...
require( "ui.uieditor.widgets.StartMenu.T10.T10StartMenu_Options" )
require( "ui.uieditor.widgets.Lobby.Common.T10ButtonListItem" )

DataSources.T10StartMenuGameOptions = ListHelper_SetupDataSource( "T10StartMenuGameOptions", function ( controller )
	local options = {}

	if CoD.isZombie then
		table.insert( options, {
			models = { displayText = "RETURN TO GAME", action = StartMenuGoBack_ListElement }
		} )
...
CoD.T10StartMenu_GameOptions_ZM.new = function ( menu, controller )
	...
	self.buttonList:setDataSource( "T10StartMenuGameOptions" )
