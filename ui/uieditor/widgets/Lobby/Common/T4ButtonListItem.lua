local PostLoadFunc = function( self, controller, menu )
    self.UpdateColors = function( self )
        ...
        CoD.UIColors.SetElementColor( self.DividerTop, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
        CoD.UIColors.SetElementColor( self.DividerBottom, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
        CoD.UIColors.SetElementColor( self.btnDisplayTextShadow, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
    end
...
CoD.T4ButtonListItem.new = function ( menu, controller )
	...
	self.btnDisplayTextShadow:setAlignment( Enum.LUIAlignment.LUI_ALIGNMENT_LEFT )
	...
	self.clipsPerState = {
		DefaultState = {
			...
			Focus = function ()
				...
				self.btnDisplayText:completeAnimation()
				self.btnDisplayText:setAlpha( 1 )
				CoD.UIColors.SetElementColor( self.btnDisplayText, CoD.PCUtil.GameOptions[controller]["colorSettings_UI"] )
