...
CoD.FE_3dTitleInternal.new = function ( menu, controller )
    ...
    --[[ local Label0 = LUI.UIImage.new()
	Label0:setLeftRight( true, false, 14.83, 330.23 )
	Label0:setTopBottom( true, false, 10.3, 40.45 )
	Label0:setRGB( 0.87, 0.9, 0.9 )
	Label0:setAlpha( 0 )
	Label0:setImage( RegisterImage( "uie_img_t7_menu_frontend_asset_bo3logo" ) )
	self:addElement( Label0 )
	self.Label0 = Label0 ]]
